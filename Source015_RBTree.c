...
//#define rb_is_red(r)
#define rb_set_black(r)	((r)->rb_parent_color & 0)
#define rb_set_black2(r)	((r)->tree.rb_parent_color & 0)
#define rb_set_red(r)	((r)->rb_parent_color = 1)
#define rb_set_red2(r)	((r)->tree.rb_parent_color = 1)
...
void rotate_left(RB_NODE* node, RB_NODE** root)
{
	...
	right->rb_left = node;
	//right->parent = parent;
	rb_set_parent(right->rb_left, parent);
...
void insert_color(RB_NODE* node, RB_NODE** root)
{
	RB_NODE* parent=0, * gparent, * uncle, * temp;
	//while ((parent = node->parent) && (parent->color == RB_RED))
